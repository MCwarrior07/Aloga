...
export default function Trending() {
    ...
    useEffect(() => {
        fetch('/api/videos?short=false')
            .then(res => res.json())
            .then(data => {
                // Sort by views
                setVideos(data.sort((a: any, b: any) => b.views - a.views).slice(0, 20));
                setLoading(false);
            });
    }, []);
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="flex items-center gap-4 mb-8 border-b border-zinc-900 pb-6">
                ...
                <div>
                    ...
                    <p className="text-zinc-500 mt-1">The most popular videos on Aloga today</p>
                </div>
            </div>
